...
const [activeCart,setActiveCart]=useState(false);
  ...
  <h3 className="font-semibold text-gray-800 ">Items:{totalQty} </h3>
     ...
     <button onClick={()=>navigate("/success")} className="bg-green-500 font-bold px-3 py-2 rounded-lg mb-5 text-white w-[90vw] lg:w-[18vw] ">Checkout
  ...
  className={`rounded-full bg-white shadow-md text-5xl p-3 fixed bottom-10 right-9
    `}
/>
